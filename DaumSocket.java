...
public class DaumSocket implements SocketHelper{
    ...
    public void FromSSL() throws IOException {
        socket = new Socket(CodeContent.DAUM, CodeContent.PORT_SSL);
    ...
    public void FromSTARTTLS() throws IOException {
        socket = new Socket(CodeContent.DAUM, CodeContent.PORT_STARTTLS);
        reader = new BufferedReader(new InputStreamReader(socket.getInputStream()));
        writer = new PrintWriter(new OutputStreamWriter(socket.getOutputStream()));
    }
